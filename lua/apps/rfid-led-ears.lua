...
--   task lua:firmware:flash:repl SCRIPT=apps/rfid-led-ears.lua
...
-- AND every line must stay under main.c's REPL_LINE (256 bytes) - a line that
...
-- simulator - task lua:apps:simulate APP=apps/rfid-led-ears.lua - before burning a JTAG round
...
GREEN_UID = "d0021a3506198b86"   -- confirmed on hardware (task lua:firmware:flash:repl)
YELLOW_UID = "d0021a35038f3a2f" -- confirmed on hardware (task lua:firmware:flash:repl)

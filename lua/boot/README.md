...
whole reason it is short. `task lua:measure ONLY=boot` re-prints that byte count
from the generated header rather than from this page — this number disagreed
with two others before anything measured it.

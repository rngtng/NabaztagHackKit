 ...
 * caller's 32-byte buffer by 8 (vinterp.c's netPmk path passes a 32-byte
 * stack array; V2's hal/wifi.c hit it as #228). Twin of the V2 fix in
 * lua/firmware/src/net/eapol.c.
 *
